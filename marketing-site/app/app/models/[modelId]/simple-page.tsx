...
export default function SimpleModelPage({ params }: { params: { modelId: string } }) {
  const { modelId } = params;
  
  console.log("Simple model page loaded");
  ...
  return (
    <div className="p-8">
      <h1 className="text-2xl font-bold mb-4">Simple Model Page</h1>
