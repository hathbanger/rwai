    ...
    <>
      <div className="w-full bg-gray-950 text-white py-16">
        <div className="max-w-[1100px] mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bold mb-8 font-sora text-white">Token Sale Structure</h2>
          ...
          <div className="prose prose-lg prose-invert max-w-none">
            ...
            <h3 className="text-xl font-bold mb-4 text-white">Token Sale Details:</h3>
            <h2 className="text-5xl font-sora font-light mb-6 bg-gradient-to-r from-white to-orange-300 bg-clip-text text-transparent">$RWAi</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {gpuData.map((gpu) => (
                <div key={gpu.id} className="bg-gray-800/80 rounded-lg overflow-hidden shadow-lg flex flex-col">
                  {/* GPU Image */}
                  ...
                  <div className="p-4 flex-grow">
                    <h4 className="text-lg font-bold mb-2 text-white">{gpu.name}</h4>
                    <p className="text-sm text-orange-400 mb-3">{gpu.specs}</p>
                  ...
                  {/* Performance Badge */}
                  <div className="bg-gray-900/80 p-3 text-xs text-center text-gray-300">
                    {gpu.performance}
                  </div>
                </div>
              ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
              <div className="bg-gray-800/80 rounded-lg p-4 shadow-lg">
                <h4 className="text-lg font-bold mb-2 text-white">$RWAi Token</h4>
                <p className="text-gray-200">The $RWAi token will be generated on Ethereum mainnet as an ERC-20, all yield will generate as USCD ERC-20.</p>
              </div>
              
              <div className="bg-gray-800/80 rounded-lg p-4 shadow-lg">
                <h4 className="text-lg font-bold mb-2 text-white">Yield Representations</h4>
                <p className="text-gray-200">Investors receive 90% of the net operating income generated by the AI rigs which is distributed on a pro-rata basis.</p>
              </div>
              
              <div className="bg-gray-800/80 rounded-lg p-4 shadow-lg">
                <h4 className="text-lg font-bold mb-2 text-white">Pro-Rata $RWAi Rights</h4>
                <p className="text-gray-200">For future sales as we expand operations, token holders will have the right to continue to purchase their pro-rate percentage of all new $RWAi offerings.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full bg-white text-gray-900 py-20">
        <div className="max-w-[1100px] mx-auto px-4 md:px-6">
